...
This project is a simulation of the classic Brick Breaker game, developed using Java Swing as part of an advanced programming course during my undergraduate studies. The primary objective was to learn and apply graphics programming in Java using Swing. The game includes features such as ball movement, paddle control, collision detection, and levels of bricks to break.
